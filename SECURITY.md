...
The application must run behind TLS with managed Postgres, OIDC, a secret manager, tenant RLS, backups, monitoring, and the controls described in `docs/RUNBOOK.md`. Development authentication and SQLite are not production-supported.
