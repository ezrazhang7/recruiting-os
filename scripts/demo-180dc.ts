...
async function main() {
  ...
  await ing.ingest(
    {
      ...
      rawText: 'This form is no longer accepting responses.',
      media: [],
  ...
  console.log(
    JSON.stringify(
      {
        organization: st.getOrganization('180dc-unc'),
        opportunities: resolveOrganization(st, '180dc-unc', new Date('2026-08-27T12:00:00Z')),
        claims: st.listClaims('180dc-unc'),
      },
      null,
      2,
    ),
